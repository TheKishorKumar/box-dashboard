    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2">
          <Link href="/" className="flex items-center gap-3 px-3 py-2 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
          ...
          <Link href="/" className="flex items-center gap-3 px-3 py-2 bg-gray-100 text-gray-900 rounded-lg">
